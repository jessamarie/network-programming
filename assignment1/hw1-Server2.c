...

{
    ...
    server_addr.sin_port = htons(0);  //the port is chosen as the first available.
    ...
    local_port = ntohs(temp_addr.sin_port); // gets port to register service
  ...
  /* Set up for clients*/
	...
	printf("made it before loop"); //for debugging
